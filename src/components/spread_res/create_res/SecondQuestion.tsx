...
const SettingAttrInput = styled(motion.input)`
  ...
  border-radius: ${(props) => props.theme.borders.small};
  &:focus {
    box-shadow: 0 0 2px 1px rgba(255, 121, 63, 1);
...
function SecondQuestion() {
  const [createManager, setCreateManager] =
    useRecoilState(createControlManager);
  ...
  const { projectType, isSandbox } = createManager;
  ...
  useEffect(() => {
    let _temp: ICreateControlManager = JSON.parse(
        ...
        <SingleNormalSetting>
          <SingleSettingQustionBox>
            ...
            <SettingBox>
                          ...
                          {DeckNameArr.map((a, i) => {
                            return (
                              <DropDownItem
                                ...
                                whileHover={dropItemVar.hover}
                                animate={
                                  i === oracleTypeNum ? dropItemVar.active : ""
                                }
              ...
              <SettingWrapperBox>
                <SettingAttrName>Optional Setting</SettingAttrName>
                <AnimatePresence>
                  {oracleTypeNum === 0 ? (
                    <>
                      <BoxWrapper
                        ...
                        exit={{ opacity: 0 }}
                      >
                        <SettingAttrLabel>Preview 3 Cards</SettingAttrLabel>
                        {/* <SettingAttrInput
                      ...
                      <BoxWrapper
                        ...
                        exit={{ opacity: 0 }}
                      >
                        <SettingAttrLabel>Auto Spread</SettingAttrLabel>
                        <DropDownBox
                    ...
                    <NoOption
                      ...
                      exit={{ opacity: 0 }}
                    >
                      <div>There are no options for this type</div>
                    </NoOption>
                  )}
                </AnimatePresence>
              </SettingWrapperBox>
