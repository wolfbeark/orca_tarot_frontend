...
function FindSingle(props : IFindSingleProps) {
    ...
    const onModeHadler = (e : React.MouseEvent<HTMLDivElement>) => {
        e.preventDefault();
        let _temp : ISingleControlManagerAtom = 
            JSON.parse(JSON.stringify(singleManager));
    ...
    // </Draggable>
        ...
        >
            <SS_FindCommon.InContainer>
                ...
                <SS_FindCommon.ImgContainer 
                    imgsrc={
                        ...
                        ? singleProjectArr[cur_ProjectNumber].zoomImgPath === null
                            ? `${process.env.PUBLIC_URL}${`/images/BackOfCards/BackOfCard0.png`}`
                ...
                >
                {singleProjectArr[cur_ProjectNumber].isFindModeZoom ? 'CURRENT : ZOOM' : 'CURRENT : FIND'}
                </SS_FindCommon.BoxForCard>
